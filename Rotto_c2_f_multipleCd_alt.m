...
title('Approach 2-R, $\bar{\tilde{C}}_D = 0.11 \pm 0.1$','interpreter','latex')
...
title('Approach 2-F, $\bar{\tilde{C}}_D = 0.29 \pm 0.15$','interpreter','latex')
...
histogram(sce3_fullupright, 'facecolor','#216869', 'edgecolor','#216869', 'Normalization', 'probability');
